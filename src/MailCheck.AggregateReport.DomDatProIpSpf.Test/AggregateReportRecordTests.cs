...
namespace MailCheck.AggregateReport.DomDatProIpSpf.Test
{
    ...
    public class AggregateReportRecordTests
    {
        ...
        public void ProviderShouldBeOverridenWhenSpfandDkimFailAndOnBlocklist(DmarcResult spfResult, DmarcResult dkimResult, int blocklistCount, string expectedProvider)
        {
            ...
            AggregateReportRecordEnriched aggregateReportRecordEnriched = CreateTestRecord(new List<string> { "domain1:pass" }, spfResult, dkimResult, blockListCount: blocklistCount, hostProvider: hostProvider);
        ...
        public void ProviderShouldBeOverridenWhenArcIsTrue()
        {
            ...
            AggregateReportRecordEnriched aggregateReportRecordEnriched = CreateTestRecord(new List<string> { "domain1:pass" }, hostProvider: hostProvider, arc: true);
            List<DomDatProIpSpfRecord> result = aggregateReportRecordEnriched.ToDomDatProIpSpfRecord();
        ...
        public void ProviderShouldNotBeOverridenWhenHostNameUnknownAndDmarcPasses()
        {
            ...
            AggregateReportRecordEnriched aggregateReportRecordEnriched = CreateTestRecord(new List<string> { "domain1:pass" }, hostProvider: hostProvider, hostName: hostName);
            List<DomDatProIpSpfRecord> result = aggregateReportRecordEnriched.ToDomDatProIpSpfRecord();
        ...
        public void ProviderShouldBeOverridenWhenHostNameUnknownAndDmarcFails()
        {
            ...
            AggregateReportRecordEnriched aggregateReportRecordEnriched = CreateTestRecord(new List<string> { "domain1:pass" }, spfResult: DmarcResult.fail, dkimResult: DmarcResult.fail, hostProvider: hostProvider, hostName: hostName);
            List<DomDatProIpSpfRecord> result = aggregateReportRecordEnriched.ToDomDatProIpSpfRecord();
        ...
        public void ProviderShouldNotBeOverridenWhenHostNameMismatchedAndSpfPasses()
        {
            ...
            AggregateReportRecordEnriched aggregateReportRecordEnriched = CreateTestRecord(new List<string> { "domain1:pass" }, dkimResult: DmarcResult.fail, hostProvider: hostProvider, hostName: hostName);
            List<DomDatProIpSpfRecord> result = aggregateReportRecordEnriched.ToDomDatProIpSpfRecord();
        ...
        public void ProviderShouldNotBeOverridenWhenHostNameMismatchedAndDkimPasses()
        {
            ...
            AggregateReportRecordEnriched aggregateReportRecordEnriched = CreateTestRecord(new List<string> { "domain1:pass" }, spfResult: DmarcResult.fail, hostProvider: hostProvider, hostName: hostName);
            List<DomDatProIpSpfRecord> result = aggregateReportRecordEnriched.ToDomDatProIpSpfRecord();
            ...
            int blockListCount = 0, string hostSourceIp = "192.168.1.1", string hostName = "hostName", string hostProvider = "mail.host.provider", bool arc = false)
        {
            return new AggregateReportRecordEnriched("id", "1", "correlationId", "causationId", "orgName", "reportId",
                ...
                spfAuthResults, 1, 1, new List<string>(){$"{headerFrom}:{dkimResult}"}, 1, 1, false, false, false, false, false, arc, false, hostName, "hostOrganisationDomain", hostProvider, 1,
