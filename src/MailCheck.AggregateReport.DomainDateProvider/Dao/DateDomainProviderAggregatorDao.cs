...
namespace MailCheck.AggregateReport.DomainDateProvider.Dao
{
    public interface IDateDomainProviderAggregatorDao
    {
        Task Save(List<DomainDateProviderRecord> records);
    }

    public class DateDomainProviderAggregatorDao : IDateDomainProviderAggregatorDao
    {
        ...
        {
            TableName = "domain_date_provider",
            FieldNames = new[]
               {
                    "domain",
                    "date",
            ...
            UpdateStatements = DateDomainProviderAggregatorDaoResources.UpdateStatements,
            ParameterValuesMapper = MapParameters
        };

        private readonly IAggregatorDao<DomainDateProviderRecord> _aggregatorDao;

        public DateDomainProviderAggregatorDao(IAggregatorDao<DomainDateProviderRecord> aggregatorDao)
        {
