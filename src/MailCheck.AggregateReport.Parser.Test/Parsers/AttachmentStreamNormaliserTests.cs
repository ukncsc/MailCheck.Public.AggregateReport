...
namespace MailCheck.AggregateReport.Parser.Test.Parsers
{
    [TestFixture]
    public class AttachmentStreamNormaliserTests
    {
        ...
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test.gz", true, false, TestName = "application/octet-stream with gz extension decompressed as gzip")]
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test.zip", false, true, TestName = "application/octet-stream with zip extension decompressed as zip")]
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test.z", false, true, true, true, true, TestName = "application/octet-stream with extension starting with z decompressed as zip")]
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test.g", true, false, true, true, true, TestName = "application/octet-stream with extension starting with g decompressed as gzip")]
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test.a", true, false, true, true, true, TestName = "application/octet-stream with extension not starting with z decompressed as gzip")]
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test", true, false, true, true, true, TestName = "application/octet-stream with no extension decompressed as gzip")]
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test.gz", true, true, false, true, true, TestName = "application/octet-stream with gz extension decompressed as zip when gzip fails")]
        [TestCase(ApplicationMediaType, OctectStreamMediaSubType, "test.zip", true, true, true, false, true, TestName = "application/octet-stream with zip extension decompressed as gzip when zip fails")]
