...
namespace MailCheck.AggregateReport.RollupDomainDate.Dao
{
    public interface IDomainDateAggregatorDao
    {
        Task Save(List<DomainDateRecord> records);
    }
    ...
    public class DomainDateAggregatorDao : IDomainDateAggregatorDao
    {
        ...
        public async Task Save(List<DomainDateRecord> records)
        {
