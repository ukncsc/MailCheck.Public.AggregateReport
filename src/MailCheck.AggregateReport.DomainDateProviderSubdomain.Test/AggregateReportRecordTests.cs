...
namespace MailCheck.AggregateReport.DomainDateProviderSubdomain.Test
{
    [TestFixture]
    public class AggregateReportRecordTests
    {
        ...
        private AggregateReportRecordEnriched CreateTestRecord(DmarcResult? spfResult = DmarcResult.pass, DmarcResult? dkimResult = DmarcResult.pass, Policy? disposition = Policy.none, int count = 0,
            string headerFrom = "digital.ncsc.gov.uk", string organisationDomain = "ncsc.gov.uk", int blockListCount = 0, string hostName = "hostName", string hostProvider = "hostProvider", bool arc = false)
        {
