...
using MailCheck.Intelligence.Api.Controllers;
using Microsoft.AspNetCore.TestHost;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection.Extensions;
using NUnit.Framework;

namespace MailCheck.Intelligence.Api.Test.Integration
{
    [TestFixture(Category = "Auth")]
    public class EndpointAuthTests : BaseIntegrationTest<StartUp, IntelligenceController>
    {
