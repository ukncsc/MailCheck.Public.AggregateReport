...
namespace MailCheck.Intelligence.Enricher.Dns
{
    ...
    {
        private readonly IEnricherConfig _config;
        ...
        public LinuxDnsNameServerProvider(IEnricherConfig config, ILogger<LinuxDnsNameServerProvider> log)
        {
            _config = config;
            _log = log;
        }
